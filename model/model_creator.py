...
def my_model(bs_size, LSTM_units,embedding_size, num_layers):
    ...
    Output_bit_0 = tf.keras.layers.Dense(1)(
        x)  # no activation is used here coz using activation might not be numerically stable
    Output_bit_1 = tf.keras.layers.Dense(1)(x)  # from logits=True is more stable than with out it
    Output_bit_2 = tf.keras.layers.Dense(1)(x)
    Output_bit_3 = tf.keras.layers.Dense(1)(x)
    Output_bit_4 = tf.keras.layers.Dense(1)(x)
    Output_bit_5 = tf.keras.layers.Dense(1)(x)
    Output_bit_6 = tf.keras.layers.Dense(1)(x)
    Output_bit_7 = tf.keras.layers.Dense(1)(x)
    Output_bit_8 = tf.keras.layers.Dense(1)(x)
    Output_bit_9 = tf.keras.layers.Dense(1)(x)
    Output_bit_10 = tf.keras.layers.Dense(1)(x)
    Output_bit_11 = tf.keras.layers.Dense(1)(x)
    Output_bit_12 = tf.keras.layers.Dense(1)(x)
    Output_bit_13 = tf.keras.layers.Dense(1)(x)
    Output_bit_14 = tf.keras.layers.Dense(1)(x)
    Output_bit_15 = tf.keras.layers.Dense(1)(x)
    Output_bit_16 = tf.keras.layers.Dense(1)(x)
    Output_bit_17 = tf.keras.layers.Dense(1)(x)
    Output_bit_18 = tf.keras.layers.Dense(1)(x)
    Output_bit_19 = tf.keras.layers.Dense(1)(x)
    Output_bit_20 = tf.keras.layers.Dense(1)(x)
    Output_bit_21 = tf.keras.layers.Dense(1)(x)
    Output_bit_22 = tf.keras.layers.Dense(1)(x)
    Output_bit_23 = tf.keras.layers.Dense(1)(x)
    Output_bit_24 = tf.keras.layers.Dense(1)(x)
    Output_bit_25 = tf.keras.layers.Dense(1)(x)
    Output_bit_26 = tf.keras.layers.Dense(1)(x)
    Output_bit_27 = tf.keras.layers.Dense(1)(x)
    Output_bit_28 = tf.keras.layers.Dense(1)(x)
    Output_bit_29 = tf.keras.layers.Dense(1)(x)
    Output_bit_30 = tf.keras.layers.Dense(1)(x)
    Output_bit_31 = tf.keras.layers.Dense(1)(x)
    Output_bit_32 = tf.keras.layers.Dense(1)(x)
    Output_bit_33 = tf.keras.layers.Dense(1)(x)
    Output_bit_34 = tf.keras.layers.Dense(1)(x)
    Output_bit_35 = tf.keras.layers.Dense(1)(x)
    Output_bit_36 = tf.keras.layers.Dense(1)(x)
    Output_bit_37 = tf.keras.layers.Dense(1)(x)
    Output_bit_38 = tf.keras.layers.Dense(1)(x)
    Output_bit_39 = tf.keras.layers.Dense(1)(x)
    Output_bit_40 = tf.keras.layers.Dense(1)(x)
    Output_bit_41 = tf.keras.layers.Dense(1)(x)
    Output_bit_42 = tf.keras.layers.Dense(1)(x)
    Output_bit_43 = tf.keras.layers.Dense(1)(x)
    Output_bit_44 = tf.keras.layers.Dense(1)(x)
    Output_bit_45 = tf.keras.layers.Dense(1)(x)
    Output_bit_46 = tf.keras.layers.Dense(1)(x)
    Output_bit_47 = tf.keras.layers.Dense(1)(x)
    Output_bit_48 = tf.keras.layers.Dense(1)(x)
    Output_bit_49 = tf.keras.layers.Dense(1)(x)
    Output_bit_50 = tf.keras.layers.Dense(1)(x)
    Output_bit_51 = tf.keras.layers.Dense(1)(x)
    Output_bit_52 = tf.keras.layers.Dense(1)(x)
    Output_bit_53 = tf.keras.layers.Dense(1)(x)
    Output_bit_54 = tf.keras.layers.Dense(1)(x)
    Output_bit_55 = tf.keras.layers.Dense(1)(x)
    Output_bit_56 = tf.keras.layers.Dense(1)(x)
    Output_bit_57 = tf.keras.layers.Dense(1)(x)
    Output_bit_58 = tf.keras.layers.Dense(1)(x)
    Output_bit_59 = tf.keras.layers.Dense(1)(x)
    Output_bit_60 = tf.keras.layers.Dense(1)(x)
    Output_bit_61 = tf.keras.layers.Dense(1)(x)
    Output_bit_62 = tf.keras.layers.Dense(1)(x)
    Output_bit_63 = tf.keras.layers.Dense(1)(x)
