# this program return two consecutive packets for the arbitration ID passed on the parameter
import numpy as np
...
def prepare_dataset(file, arbitration_id):
    ...
    for line in file:
        ...
        if arb_id == arbitration_id.lower():
            while len(data) < 16:
                data=data+'00'
...
if __name__ == "__main__":
    print("in file")
    print(np.array(prepare_dataset('temp_file.txt', all_ids[0])).shape)