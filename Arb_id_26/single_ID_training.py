...
import preprocessors.frame_reader_from_file as frame_reader_from_file
import numpy as np
import preprocessors.bits_extractor as bits_extractor
import tensorflow as tf
import preprocessors.dataset_creator as dataset_creator
import preprocessors.model_creator_sigmoid as model_creator_sigmoid
...
file = open("../datasets/normal_run_data.txt",'r')

data = frame_reader_from_file.prepare_dataset(file, arbitration_id=all_ids[26])
print(len(data))
